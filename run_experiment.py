...
datamanager = torchreid.data.ImageDataManager(
    ...
    batch_size_test=256,
    combineall=False,
    train_sampler='RandomIdentitySampler' if args.loss in ['triplet', 'contrastive', 'arcface'] else 'RandomSampler',
    num_instances=6,
)
...
if args.loss == 'triplet':
    ...
    engine = TripletCenterEngine(datamanager, model, optimizer, scheduler=scheduler, weight_center=0.005, weight_triplet=1)
else:
